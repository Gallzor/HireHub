...
class landingtestFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Koppelen van klikactie aan de userProfileButton
        binding.userProfileButton.setOnClickListener {
            // Starten van UserProfileActivity wanneer de button wordt geklikt
            val intent = Intent(requireActivity(), UserProfileActivity::class.java)
            startActivity(intent)
        }

        // Koppelen van klikactie aan de accountButton
        binding.btnMyAccount.setOnClickListener {
            // Starten van AccountActivity wanneer de knop wordt geklikt
        ...
        val isUserLoggedIn = sessionManager.getUserId() != -1

        // Pas de zichtbaarheid van de accountButton aan op basis van de inlogstatus
        if (isUserLoggedIn) {
            binding.btnMyAccount.visibility = View.VISIBLE
        } else {
            binding.btnMyAccount.visibility = View.GONE
        }
    }
...
//import android.view.ViewGroup
//import androidx.fragment.app.Fragment
//import com.example.hirehub.AccountActivity
//import com.example.hirehub.LoginActivity
//import com.example.hirehub.Profileboard.ProfileboardActivity
//import com.example.hirehub.UserProfile.UserProfileActivity
//import com.example.hirehub.Userboard.UserboardActivity

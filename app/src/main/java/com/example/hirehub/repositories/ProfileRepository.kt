...
class ProfileRepository(private val profileDao: ProfileDao) {
     ...
     * @param profile De profiel die moet worden toegevoegd.
     */
    @WorkerThread
     ...
     * @param profile De profiel met bijgewerkte gegevens.
     */
    @WorkerThread
     ...
     * @param profile De profiel die moet worden verwijderd.
     */
    @WorkerThread
